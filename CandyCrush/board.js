...
var Board = function(size)
{
    ...
    var candyCounter = 0;
    //Naming the columns
    var columnName = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h','i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't'];
    //Returning the column Name
    this.getColumnName = function(col){
        return columnName[col];
    }
    //Returning the column Number
    this.getColumnNumber = function(col){
        return columnName.indexOf(col);
    }

    this.getImageFromColorName = {'blue': 'blue-candy.png', 'red': 'red-candy.png', 'orange': 'orange-candy.png',
        'yellow': 'yellow-candy.png', 'green': 'green-candy.png', 'purple': 'purple-candy.png' };

    this.getCellName = function(x,y) {
        var cellName = this.getColumnName(x)+parseInt(y+1);
        return cellName;
    }
    ...
    */
    ...
    {
        //console.log(this.square[row][col]);
        if (this.isEmptyLocation(row,col))
        {
